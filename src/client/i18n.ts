...
export const dict = {
  en: {
    title: '9router Key Manager', subtitle: 'Daily token quota control. Set limit → watcher disables key when exceeded → daily reset can re-enable it.', refresh: 'Refresh', loginTitle: 'Admin access', password: 'Password', unlock: 'Unlock', wrong: 'Wrong password', lang: 'Language', logout: 'Logout', publicCheck: 'Public key check', check: 'Check', keyInput: 'Paste your API key', backAdmin: 'Admin login', notFound: 'Key not found', needs: 'Needs attention', tokens: 'Today tokens', req: 'Requests', active: 'Active keys', cost: 'Cost', auto: 'Auto-disable', flow: 'Recommended flow', f1: '1. Pick a key', f2: '2. Set daily limit', f3: '3. Action = disable', f4: '4. Watcher locks until next UTC+7 day', healthy: 'Everything looks healthy.', status: 'Status', name: 'Name', usage: 'Quota used', daily: 'Daily limit', window: 'Window', action: 'Action', last: 'Last use', inputTokens: 'Input tokens', outputTokens: 'Output tokens', noModels: 'No model usage yet.', quick1: 'Quick: daily limit 2× current', quick2: '50M/day + disable', limit: 'Daily/token limit', reset: 'Reset policy', expires: 'Expires at UTC+7', save: 'Save policy', saving: 'Saving…', resetNow: 'Reset manual/custom window now', usageTitle: 'Usage', total: 'Total', prompt: 'Prompt', completion: 'Completion', models: 'Models', audit: 'Audit', noAudit: 'No audit events.', setup: 'Setup needed', automaticWindow: 'Daily/monthly windows reset automatically; manual reset is only for manual/custom policies.', multiplier: 'Usage multiplier', finalFallback: 'Allow final fallback', actualTotal: 'Actual total', duplicates: 'Deduped tokens', viewDetail: 'View details', detailTitle: 'Model usage detail', back: 'Back', modelName: 'Model', share: 'Share', totalTokens: 'Total tokens', keyNotFound: 'Key not found', loading: 'Loading…', allowedModels: 'Allowed models', allowedModelsPlaceholder: 'One model per line', allowedModelsHint: 'Empty = allow all models. Only the original incoming model is checked; rewrite targets and final fallback are not restricted.', restrictedBadge: 'Restricted', requestLogs: 'Request logs', cache: 'Cache', cacheRead: 'Cache read', cacheWrite: 'Cache write', cacheAll: 'Any', cacheReadOnly: 'Read > 0', cacheWriteOnly: 'Write > 0', cacheNone: 'None', range: 'Range', range7d: '7 days', range30d: '30 days', range90d: '90 days', rangeCustom: 'Custom', from: 'From (UTC+7)', to: 'To (UTC+7)', prev: 'Prev', next: 'Next', pageSize: 'Page size', provider: 'Provider', noLogs: 'No requests in this window.', clearUsage: 'Clear usage history', clearUsageConfirm: 'Clear all usage history for {name}? This action cannot be undone.'
  },
  vi: {
    title: '9router Key Manager', subtitle: 'Quản lý quota token theo ngày. Đặt giới hạn → watcher tắt key khi vượt → qua ngày UTC+7 có thể tự bật lại.', refresh: 'Làm mới', loginTitle: 'Truy cập quản trị', password: 'Mật khẩu', unlock: 'Mở khóa', wrong: 'Sai mật khẩu', lang: 'Ngôn ngữ', logout: 'Đăng xuất', publicCheck: 'Kiểm tra key công khai', check: 'Kiểm tra', keyInput: 'Nhập API key của bạn', backAdmin: 'Đăng nhập admin', notFound: 'Không tìm thấy key', needs: 'Cần chú ý', tokens: 'Token hôm nay', req: 'Số request', active: 'Key đang bật', cost: 'Chi phí', auto: 'Tự tắt key', flow: 'Flow khuyến nghị', f1: '1. Chọn key', f2: '2. Đặt daily limit', f3: '3. Action = disable', f4: '4. Watcher khóa tới ngày UTC+7 tiếp theo', healthy: 'Mọi thứ ổn.', status: 'Trạng thái', name: 'Tên', usage: 'Đã dùng quota', daily: 'Giới hạn/ngày', window: 'Chu kỳ', action: 'Hành động', last: 'Dùng gần nhất', inputTokens: 'Input token', outputTokens: 'Output token', noModels: 'Chưa có lượt dùng model.', quick1: 'Nhanh: limit/ngày = 2× hiện tại', quick2: '50M/ngày + disable', limit: 'Giới hạn token/ngày', reset: 'Chính sách reset', expires: 'Hết hạn lúc UTC+7', save: 'Lưu policy', saving: 'Đang lưu…', resetNow: 'Reset chu kỳ manual/custom', usageTitle: 'Sử dụng', total: 'Tổng', prompt: 'Prompt', completion: 'Completion', models: 'Models', audit: 'Audit', noAudit: 'Chưa có audit.', setup: 'Cần setup', automaticWindow: 'Chu kỳ daily/monthly tự reset; reset thủ công chỉ áp dụng cho manual/custom.', multiplier: 'Hệ số usage', finalFallback: 'Cho phép final fallback', actualTotal: 'Token thực tế', duplicates: 'Token đã khử trùng lặp', viewDetail: 'Xem chi tiết', detailTitle: 'Chi tiết sử dụng theo model', back: 'Quay lại', modelName: 'Model', share: 'Tỷ trọng', totalTokens: 'Tổng token', keyNotFound: 'Không tìm thấy key', loading: 'Đang tải…', allowedModels: 'Model được phép', allowedModelsPlaceholder: 'Mỗi model một dòng', allowedModelsHint: 'Để trống = cho phép tất cả model. Chỉ kiểm tra model gốc gửi lên; rewrite target và final fallback không bị giới hạn.', restrictedBadge: 'Giới hạn', requestLogs: 'Log request', cache: 'Cache', cacheRead: 'Cache đọc', cacheWrite: 'Cache ghi', cacheAll: 'Tất cả', cacheReadOnly: 'Có đọc', cacheWriteOnly: 'Có ghi', cacheNone: 'Không có', range: 'Khoảng', range7d: '7 ngày', range30d: '30 ngày', range90d: '90 ngày', rangeCustom: 'Tùy chỉnh', from: 'Từ (UTC+7)', to: 'Đến (UTC+7)', prev: 'Trước', next: 'Sau', pageSize: 'Số dòng', provider: 'Provider', noLogs: 'Chưa có request trong khoảng này.', clearUsage: 'Xóa lịch sử sử dụng', clearUsageConfirm: 'Xóa toàn bộ lịch sử sử dụng của {name}? Thao tác này không thể hoàn tác.'
  }
} as const;
